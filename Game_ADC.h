 ...
 */
void MyADC_Init(ADC12_Regs *adc12, uint32_t channel, uint32_t reference);
 ...
 * @brief  Trigger ADC measurement and wait for result.
 */
uint32_t MyADC_In(ADC12_Regs *adc12);
 ...
 */
void MyADC_InitDual(ADC12_Regs *adc12, uint32_t channel1, uint32_t channel2, uint32_t reference);
 ...
 */
void MyADC_InDual(ADC12_Regs *adc12, uint32_t *d1, uint32_t *d2);
 ...
 */
void MyADC_InitTriple(ADC12_Regs *adc12,uint32_t channel1,uint32_t channel2,uint32_t channel3,uint32_t reference);
 ...
 */
void MyADC_InTriple(ADC12_Regs *adc12,uint32_t *d1, uint32_t *d2, uint32_t *d3);
 ...
 */
void MyADC0_InitAve(uint32_t channel, uint32_t n);
